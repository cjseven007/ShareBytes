...
Public Class RiderRevenueForm
    Dim connect As New OleDbConnection
    Dim command As New OleDbCommand
    Dim sql As String = Nothing
    Dim totalRevenue As Double
    Private Sub RiderRevenueForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        sql = "SELECT * FROM Donations WHERE riderID = @RiderID AND deliverStatus = 'Delivered'"
        ...
        While reader.Read()
            ...
            Dim fare As String = (CDbl(reader("fare").ToString()) * 0.7).ToString("0.00")
