...
Public Class RiderHomeForm
    ...
    Public Sub RefreshData()
        ...
        sql = "SELECT * FROM Donations WHERE deliverStatus = 'Paid'"
        ...
        reader.Close()
    End Sub
    Private Sub RiderHomeForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
